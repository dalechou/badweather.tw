...
- [「時間問題」遊戲內動畫](https://youtu.be/Nxp7rC1yKlE)
...
- **聯盟跟部落現在可以同公會了？**
    ...
    沒錯，本公會聯盟和部落的玩家已經合併在同一個公會了（聖光之願聯盟）！
...
- **禁忌之境（新地圖）有好多任務，可以直接跟我說要幹嘛嗎？**

    隨著劇情推進，收集澤斯克拉密庫鑰匙，最終可以獲得瑪瑙環飾（有三個插槽的戒指）與原初之石（可以插入戒指的厲害石頭）。
    
    澤斯克拉密庫總共有 29 個門，可以先打稀有怪，收集好 29 把鑰匙，一次打開澤斯克拉密庫所有的門。
    
    低等級的原初之石可以透過 10 個休眠的源初碎片和 25 個光滑寶石粉升級。光滑寶石粉在拍賣場即可購買，所以重點是收集休眠的源初碎片。
    
    每顆原初之石可以升級兩次，瑪瑙環飾可以插入三顆原初之石，所以 10 × 2 × 3 = 60，只要 60 個休眠的源初碎片，就可以把戒指升到最高裝等。
