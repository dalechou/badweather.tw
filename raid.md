...
| --- | --- | --- | --- |
| Darc | **香緹紗** | 一灰羽一 | 安腥氬 |
| **喔啊啊** | 加五元變大薯 | Yoyoman | 諾勒斯夜咒 |
| **龍蝦三爭霸** | 沙發破一個洞 | 呆萌包子 | 狼師獸液 <sup>1</sup> |
| | **小兔牙妹** | 在光中升起 | 烏邦果 |
| | 貝武夫 | 星火燎原 | 鐵礦 |
| | 妹妹大人 | 奈何 | 先發 <sup>1</sup> |
| | 老婆不在家 | 取名真是難 | 坎達爾珍娜 |
| | | 灰瞳 | 獨孤小乩醬 |
| | | 撞牆當練功　| 橒夢 |
| | | 霹靂嬌媽 | 猛難達 |
...
這是固定出團名單，每週請用名單上的角色出團。團員 32 人。

粗體字表示雙修專精，只列出目前團隊會用到的，辛苦你們了。

## 出席報告

狼師獸液目前出席狀況第一名，但因為是新手爸爸，所以他想讓給第二名；霹靂嬌媽 5/31 至 6/21 之間全勤，依先前公布的方法轉固定席位。

- 7/5 請假：一灰羽一、老婆不在家；會晚到：坎達爾珍娜、星火燎原
- 7/19 請假：特里維亞
- 7/26 請假：特里維亞
- 8/2 請假：特里維亞

版本末請假 <sup>2</sup>：加五元變大薯

<sup>1</sup> 遞補席位。相關說明請繼續往下看。

<sup>2</sup> 相關說明請繼續往下看。

## 關於分身

分身分兩班。兩班輪流開分身上來。

第一班：坎達爾珍娜、橒夢（7/5 換 Virtus）、撞牆當練功
...
出團紀錄請看 [Warcraft Logs](https://www.warcraftlogs.com/user/reports-list/302729/)。
...
團長會在版本末、接近下一個版本的某個時間點開啟「版本末請假機制」。這時候固定席位團員可以請長假「等改版」而不影響下一版的固定席位。

需要請假的團員可以在跟團長討論後，多利用這段時間休息，下一個版本開放再回來一起拓荒！

請假時間定義：由團長開啟版本末請假機制，至下一個版本開團止。下一個版本會在第一個 CD 開團，第一個 CD 尚未準備好的固定席位團員取消固定席位。

另外，既然有了這個請假機制，就不會特別在版本末休團，會一直開到最後一個 CD。開啟版本末請假機制後，遞補席位暫時不會轉固定席位，直到下一個版本的第一個 CD。
