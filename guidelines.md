...
| **會倉分頁** | **頁面名稱**   | **使用說明**                                                                                |
| ------------ | -------------- | -------------------------------------------------------------------------------------------- |
| 一           | 混亂市集       | 想貢獻物資，但不知道放哪裡？有東西很希望其他人用掉？可以用這一頁。（拿到寵物要當好主人喔！） | 
| 二           | 還算有用的雜物 | 當前版本還算有用的雜物可以用滑鼠右鍵丟進來。請盡量確認是「有用」的。                         | 
| 三、四       | 當前版本物資   | 當前版本物資可以用滑鼠右鍵丟進來。舊版本物資請放到第六頁。                                   | 
| 五           | 各種大吃大喝   | 食物可以用滑鼠右鍵丟進來。盡量以當前版本食物為主。                                           | 
| 六           | 舊版本物資     | 舊版本布、皮、草、礦、附魔材料可以用滑鼠右鍵丟進來。                                         | 
| 七           | 捐獻出團物資   | 這裡放的物資是公會出團活動會用到的珍貴材料。無論捐獻多少，都可以幫到做大鍋、大餐的人。       | 
| 八           | 出團用         | [Raiders](ranks.html) 專用。                                                                 | 
