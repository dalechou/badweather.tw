...
| 第二頁     | 還算有用的雜物 | 當前版本還算有用的雜物可以用滑鼠右鍵丟進來。請盡量確認是「有用」的。                         | 
| 第三、四頁 | 當前版本物資   | 當前版本物資可以用滑鼠右鍵丟進來。舊版本物資請放到第六頁。                                   | 
| 第五頁     | 各種大吃大喝   | 食物可以用滑鼠右鍵丟進來。盡量以當前版本食物為主。                                           | 
| 第六頁     | 舊版本物資     | 舊版本布、皮、草、礦、附魔材料可以用滑鼠右鍵丟進來。                                         | 
| 第七頁     | 捐獻出團物資   | 這裡放的物資是公會出團活動會用到的珍貴材料。無論捐獻多少，都可以幫到做大鍋、大餐的人。       | 
