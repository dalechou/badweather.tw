# Bad Weather
### [首頁](index.html)　　公會須知　　[回鍋資訊](oldfriends.html)　　[收人規則](recruitment.html)　　[團隊活動](raid.html)　　[公會活動](activities.html)　　[公會語音](voicechat.html)
...
除了遊戲中既有的聯絡方式（密語、信件），公會設有[匿名幹部信箱](https://1a4nr73j.forms.app/mailbox)，也可以使用，但請記得留下聯絡方式。我們希望可以在瞭解情況後為公會做出正確決策，並以既有資源盡力提供幫助。
...
接下來請完成[會員升階表](https://1a4nr73j.forms.app/badweather)獲得完整的會員權利（1 min，不會收集電子郵件地址或個人資訊）。完成這個步驟才算正式加入公會，請不要因為害羞就跳過喔。
