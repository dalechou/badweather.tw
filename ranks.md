...
積極為公會服務的製造工匠角色可晉升為 `Crafter`。穩定參與[團隊活動](raid.html)的角色可晉升為 `Raider`。這兩個會階認定的是角色，不是帳號或人。
...
- 移除兩年未上線，並且等級未滿兩個大版本以前最高等級的主要角色。（以十二版《至暗之夜》來說，會看十版的最高等級，也就是 70。）
- 保留 `Dreamer` 和 `AFK <3` 會階所有角色。
- 分身眾多的會員，我們會保留最常用的六個角色，但有三種角色不會納入計算：`Crafter` 會階的角色、混搭再造的時光奔流者以及[偉大的諾姆瑞根路跑](activities.html)專用小地精，這些角色不會占用名額。
